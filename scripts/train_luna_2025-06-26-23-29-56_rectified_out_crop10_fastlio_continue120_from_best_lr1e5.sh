...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-4}" python -u stereo_lidar.py \
  --checkpoint_dir outputs/luna_2025-06-26-23-29-56_rectified_out_crop10_fastlio_continue120_from_best_lr1e5 \
  --train_datasets luna \
  --test_datasets luna \
  ...
  --resume_ckpt outputs/luna_2025-06-26-23-29-56_rectified_out_crop10_fastlio_from_pretrained_lr1e5_ep120/ckpt_best.pth \
  --strict_resume 0 \
  --max_disp 192 \
  --image_size 256 512 \
