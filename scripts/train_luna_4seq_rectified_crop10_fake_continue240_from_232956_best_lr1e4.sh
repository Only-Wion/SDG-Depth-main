...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-4}" python -u stereo_lidar.py \
  --checkpoint_dir outputs/luna_4seq_rectified_crop10_fake_continue240_from_232956_best_lr1e4 \
  --train_datasets luna \
  --test_datasets luna \
  ...
  --luna_lidar_source fake \
  --luna_border_crop_fraction 0.1 \
  --resume_ckpt outputs/luna_2025-06-26-23-29-56_rectified_crop10_fake_from_pretrained_lr1e4_ep240/ckpt_best.pth \
  --strict_resume 0 \
  --reset_best_val 1 \
  --max_disp 192 \
  --image_size 256 512 \
